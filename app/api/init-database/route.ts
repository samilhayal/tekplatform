...
export async function POST() {
  try {
    ...
    // ============================================
    // 11. JOB CHANGE SETTINGS - İş Değişikliği Hesaplama Ayarları
    // ============================================
    const jobChangeSettingsRef = adminDb.collection('jobChangeSettings').doc('current')
    await jobChangeSettingsRef.set({
      yil: 2025,
      // Vergi Dilimleri (2025)
      vergiDilimleri: [
        { limit: 110000, oran: 0.15, aciklama: '0 - 110.000 TL arası %15' },
